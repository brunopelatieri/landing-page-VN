...
export default function ObrigadoCLT() {
  ...
  const copy = `Suas informações foram recebidas com segurança e já seguem para análise especializada.
Caso haja qualquer atualização, entraremos em contato pelos meios cadastrados.`;
      ...
      <section className="obrigado-clt-section">
        <div className="obrigado-clt-inner">
          <div className="obrigado-clt-left">
            <h1>Obrigado!</h1>
            <p className="obrigado-sub">Seu formulário foi enviado com sucesso.</p>
